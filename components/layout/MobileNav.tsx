...
export default function MobileNav() {
  ...
  return (
    <div className="flex md:hidden items-center justify-between h-16 px-4 bg-white border-b border-gray-100">
      
      {/* 1. FAR LEFT: Hamburger Menu Icon */}
      <button 
      ...
      {/* ================================================= */}
      {/* MOBILE SLIDE-OUT DRAWER (Opened via Hamburger)     */}
      {/* ================================================= */}
      {isOpen && (
          ...
          <div className="relative w-[85%] max-w-sm bg-white h-full shadow-2xl flex flex-col z-10 animate-in slide-in-from-left duration-200">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="flex flex-col text-brand-charcoal font-medium text-sm">
                <Link href="/" onClick={() => setIsOpen(false)} className="px-5 py-4 border-b border-gray-50 hover:bg-gray-50">
                  Home
                </Link>
                ...
                <div>
                  ...
                  {isCategoryOpen && (
                    <div className="bg-gray-50 flex flex-col border-b border-gray-100">
                      <Link href="/category/smartphones" onClick={() => setIsOpen(false)} className="py-3 pl-8 text-gray-600 hover:text-brand-primary">
                        Smartphones & Phones
                      </Link>
                      <Link href="/category/phone-accessories" onClick={() => setIsOpen(false)} className="py-3 pl-8 text-gray-600 hover:text-brand-primary">
                ...
                <Link href="/shop" onClick={() => setIsOpen(false)} className="px-5 py-4 border-b border-gray-50 hover:bg-gray-50">
                  View All
                </Link>
                <Link href="/cart" onClick={() => setIsOpen(false)} className="flex items-center justify-between px-5 py-4 border-b border-gray-50 hover:bg-gray-50">
                ...
                <Link href="/wishlist" onClick={() => setIsOpen(false)} className="flex items-center justify-between px-5 py-4 border-b border-gray-50 hover:bg-gray-50">
                  <span className="flex items-center gap-3"><Heart className="w-4 h-4 text-red-500"/> Lists</span>
                </Link>
              </div>
            </div>
