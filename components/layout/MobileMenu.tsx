  ...
  return (
    <>
      ...
      <button 
        ...
        className="p-1 text-gray-800 focus:outline-none hover:text-black transition-colors"
        aria-label="Open Navigation Menu"
      >
        <Menu className="h-7 w-7" strokeWidth={2.5} />
      </button>

      {/* Drawer Backdrop + Content Wrapper */}
      <div 
      ...
      >
        ...
        {/* Drawer Content - Native Tailwind Slide Transition */}
        <div 
          className={`fixed top-0 left-0 bottom-0 w-[85%] max-w-sm bg-white h-full shadow-2xl flex flex-col z-[101] transition-transform duration-300 ease-in-out transform ${
