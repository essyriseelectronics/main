...
export default async function Footer() {
  ...
  return (
    <footer id="contact" className="bg-brand-charcoal text-white py-12 mt-12 border-t border-gray-800">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        
        {/* Brand Info */}
        <div>
          <div className="flex flex-col items-start mb-4">
            <span className="text-xl font-extrabold text-white tracking-tight leading-none">ESSYRISE</span>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li className="pt-2">
              ...
              <a href="tel:0784269950" className="hover:text-brand-accent transition-colors font-medium">0784 269 950</a>
              <span className="mx-2 text-gray-600">|</span>
              <a href="tel:0759984350" className="hover:text-brand-accent transition-colors font-medium">0759 984 350</a>
            </li>
