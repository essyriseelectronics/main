...
export default function Header() {
  ...
  // 1. RESTORED: JavaScript width check to prevent desktop/mobile overlap
  useEffect(() => {
        ...
        {!isMobile ? (
          ...
          <div className="relative">
            ...
            <div className="relative flex items-center justify-between h-16 px-4 w-full">
              <button 
                className="p-2 -ml-2 text-brand-charcoal hover:bg-gray-50 rounded-lg flex items-center justify-center transition-colors focus:outline-none z-10"
              ...
              <div className="flex items-center gap-2 z-10">
                <button 
                  className="p-2 text-brand-charcoal hover:bg-gray-50 rounded-lg flex items-center justify-center transition-colors"
                  onClick={() => setIsMobileMenuOpen(true)}
                  aria-label="Open Search"
                >
                  <Search className="w-6 h-6" strokeWidth={1.5} />
                </button>
                <Link href="/cart" className="p-2 text-brand-charcoal hover:bg-gray-50 rounded-lg relative flex items-center justify-center transition-colors" aria-label="Cart">
