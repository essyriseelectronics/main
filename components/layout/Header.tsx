...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-100 shadow-sm">
      ...
      {/* ================================================= */}
      {/* 2. MOBILE HEADER & DRAWER (Hidden on Desktop)     */}
      {/* ================================================= */}
      <div className="md:hidden">
        ...
        <div className="relative flex items-center justify-between h-16 px-4 w-full">
          <button 
            className="p-2 -ml-2 text-brand-charcoal hover:bg-gray-50 rounded-lg flex items-center justify-center transition-colors focus:outline-none"
        ...
        {/* ================================================= */}
        {/* EXACT ETOMU MOBILE DRAWER STRUCTURE               */}
        {/* ================================================= */}
        {isMobileMenuOpen && (
