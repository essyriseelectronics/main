  ...
  return (
    <>
      ...
      <div className="flex md:hidden items-center justify-between h-14 w-full relative z-50">
        <div className="flex-none">
          <button 
            ...
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation(); // Prevents clicks from being stolen by invisible wrappers
              console.log("Hamburger TAPPED! Changing state to true.");
              setIsOpen(true);
            }}
            // Added high z-index and an active scale effect so you can visually confirm the tap
            className="p-2 -ml-2 text-gray-800 focus:outline-none cursor-pointer relative z-[60] active:scale-90 transition-transform"
        ...
        <div className="flex-none flex items-center gap-3 relative z-[60]">
      ...
      {/* 
        ...
        Instead of conditional rendering, we ALWAYS render it and slide it with CSS.
        This completely prevents React hydration/mounting lag on mobile devices.
      */}
      <div 
        className={`fixed inset-0 z-[100] flex md:hidden transition-opacity duration-300 ${
      ...
      >
        ...
        {/* Drawer Panel - Slides in from the left smoothly */}
        <div 
